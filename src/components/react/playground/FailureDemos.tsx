...
function BadChunkingDemo() {
  ...
  return (
    <div style={{
      ...
      <h4 style={{ margin: '0 0 0.5rem', color: '#EF4444', fontSize: '0.9375rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        {/* Bad chunks */}
        <div>
          <div style={{ fontWeight: 600, fontSize: '0.8125rem', color: '#EF4444', marginBottom: '0.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
            {badChunks.slice(0, 6).map((c, i) => (
              <div key={i} style={{
                ...
                borderRadius: '0.25rem', fontSize: '0.6875rem', fontFamily: "'JetBrains Mono', monospace",
              }}>
                "{c.text}"
              </div>
            ))}
            {badChunks.length > 6 && (
              <div style={{ fontSize: '0.6875rem', color: '#94a3b8' }}>...+{badChunks.length - 6} more fragments</div>
            )}
          </div>
        ...
        {/* Good chunks */}
        <div>
          <div style={{ fontWeight: 600, fontSize: '0.8125rem', color: '#22C55E', marginBottom: '0.5rem' }}>
      ...
      <div style={{
        ...
        borderRadius: '0.375rem', fontSize: '0.75rem', color: '#F59E0B',
      }}>
...
function NoContextDemo() {
  return (
    <div style={{
      ...
      <h4 style={{ margin: '0 0 0.5rem', color: '#F59E0B', fontSize: '0.9375rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        ...
        <div>
          ...
          <div style={{
            ...
            borderRadius: '0.375rem', fontSize: '0.8125rem', lineHeight: 1.6,
          }}>
            {NO_CONTEXT_ANSWER}
          </div>
        </div>
